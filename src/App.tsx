...
function App() {
  ...
  const onEnter = () => {
    ...
    if (
      newGuess.length < CONFIG.wordLength &&
      guesses.length < CONFIG.tries &&
      !isGameWon
    ) {
      newGuess = newGuess
      ...
      if (!(newGuess.length === CONFIG.wordLength)) {
    ...
    if (!isWordInWordList(newGuess.join(''))) {
      setIsWordNotFoundAlertOpen(true)
      return setTimeout(() => {
        setIsWordNotFoundAlertOpen(false)
      }, ALERT_TIME_MS)
    }
    const winningWord = isWinningWord(newGuess.join(''))
  ...
  return (
    <div className="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div className="text-center py-10">
        Liked this? Also try{' '}
        <a
          href="https://calvinballing.github.io/whodle"
      ...
      <Alert
        message="Not enough letters (need 5 letters and 5 spaces)"
        isOpen={isNotEnoughLetters}
      />
      <Alert
        message="Guess common 5-letter words from the Wordle dictionary with 5 spaces somewhere before or after"
